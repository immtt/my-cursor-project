...
function renderResult() {
  ...
  document.getElementById("queryBtn").onclick = async () => {
    ...
    rows.forEach((r) => {
      ...
      appendCell(tr, r.sys_waybill_no);
      appendCell(tr, r.manual_waybill_no);
      appendCell(tr, r.match_status);
      appendCell(tr, r.store_match_rate);
      appendCell(tr, r.volume_diff_rate);
      appendCell(tr, r.line_consistent);
      appendCell(tr, r.est_distance_diff);
      appendCell(tr, r.est_duration_diff);
