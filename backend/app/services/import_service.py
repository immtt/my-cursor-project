...
def _required_text(values, header_map, column_name):
    value = values[header_map[column_name]]
    if value is None:
        return ""
    return str(value).strip()


def _optional_float(values, header_map, column_name, default=0.0):
...
def _optional_int(values, header_map, column_name, default=0):
    return int(_optional_float(values, header_map, column_name, default))
